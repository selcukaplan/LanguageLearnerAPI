...
import ResponseFactory, {ResponseData} from "../factories/responseFactory";
...
export default class UserController {
    ...
    static async signUpUser(request: Request,response: Response,next: NextFunction) {
        try {
            ...
            const responseData: ResponseData<string> = ResponseFactory.createResponseData(newUserToken);
    ...
    static async loginUser(request: Request,response: Response,next: NextFunction) {
        try {
            ...
            const responseData: ResponseData<string> =ResponseFactory.createResponseData(userToken);
    ...
    static async getUsersHasSameForeignLanguages(request: Request, response: Response, next: NextFunction) {
        try {
            ...
            const responseData = ResponseFactory.createResponseData(otherUsers);
            return response.status(StatusCodes.OK).json(responseData);
        } catch (error) {
            next(error);
        }
    ...
    static async getUsers(request: Request,response: Response,next : NextFunction) {
        try {
            ...
            const responseData = ResponseFactory.createResponseData(users);
            return response.status(StatusCodes.OK).json(responseData);
        } catch (error) {
            next(error);
        }
    ...
    static async getFriendsOfUser(request: Request
        ...
        try {
            ...
            const responseData = ResponseFactory.createResponseData(friendsOfUser);
            return response.status(StatusCodes.OK).json(responseData);
        } catch (error) {
            next(error);
        }
    ...
    static async updateUser(request: Request
        ...
        try {
            ...
            const responseData=ResponseFactory.createResponseData(newUserInfo)
            return response.status(StatusCodes.OK).json(responseData);
        } catch (error) {
            next(error);
        }
    ...
    static async addFriendToUser(request: Request
        ...
        try {
            ...
            const responseData=ResponseFactory.createResponseData(updatedUser);
            return response.status(StatusCodes.OK).json(responseData);
        } catch (error) {
            next(error);
        }
